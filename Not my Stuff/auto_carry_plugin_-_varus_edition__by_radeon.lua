  ...
  \ \ \/\ \ \ \_\ \\ \ \_/\ \L\ \   \ \ \L\ \/\ \L\.\_\ \ \/ \ \ \/ \ \ \_\ \   \ \ \/   \_\ \_\ \ \_\ \/\ \L\ \ \ \/\ \/\ \ 
   \ \_\ \_\ \____/ \ \__\ \____/    \ \____/\ \__/.\_\\ \_\  \ \_\  \/`____ \   \ \_\   /\____\\ \____/\ \____ \ \_\ \_\ \_\
    \/_/\/_/\/___/   \/__/\/___/      \/___/  \/__/\/_/ \/_/   \/_/   `/___/> \   \/_/   \/____/ \/___/  \/___L\ \/_/\/_/\/_/
        ...
        Combo - E -> R ->
		Note:	This is my first script, the prediction is not the best but works as well :3
				Thank you DeniCevap to letting me use his Lux Auto Carry Plugin as base of my varus plugin.
...
function PluginOnLoad()
        ...
        SkillE = {spellKey = _E, range = eRange, speed = 1.75, delay = 220, width = 0}
		...
		AutoCarry.PluginMenu:addParam("useR", "Use Chain of Corruption [R]", SCRIPT_PARAM_ONOFF, true)
