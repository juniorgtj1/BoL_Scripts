...
function OnLoad()
	...
	ConfigDraw:addParam("drawVisionRangePlayer", "Draw Player Vision Range", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("C"))
	ConfigDraw:addParam("drawVisionRangeMinion", "Draw Minion Vision Range", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("V"))
